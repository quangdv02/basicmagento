...
class SM_Slider_Block_Adminhtml_Slider_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs{
    ...
    protected function _beforeToHtml()
    {
        ...
        $this->addTab('form_section1', array(
            'label'     => Mage::helper('slider')->__('Images Information'),
            'title'     => Mage::helper('slider')->__('Images Information'),
            'content'   => $this->getLayout()->createBlock('slider/adminhtml_slider_edit_tab_image')->toHtml(),
        ));
